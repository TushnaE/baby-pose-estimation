...
cap = cv2.VideoCapture('/Users/tushna/Desktop/Desktop /Classes/Projects/HumanPoseEstimation/pytorch-openpose/images/mov2avi.avi')  ## tried w babyjump.avi --> didnt work, couldnt open file w videocap
fourcc = cv2.VideoWriter_fourcc(*'XVID') ## maybe try one that works best w OSX
